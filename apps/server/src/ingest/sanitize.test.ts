...
import { BRIDGE,MOVE_READER_CSS,READER_CSS,canonicalTextNodePlan,canonicalizeBlockText,looseAcademicCaptionKind,normalizeAssetPath,sanitizeDocument,sanitizeStylesheet,textFragmentsForOffsets } from './sanitize.js';
