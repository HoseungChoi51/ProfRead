...
export async function buildApp() {
  ...
  seedModelSettings();registerDocumentRoutes(app);registerThreadRoutes(app);registerRunRoutes(app);registerSettingsRoutes(app);registerKnowledgeRoutes(app);registerExportRoutes(app);
