...
export async function buildApp() {
  ...
  seedModelSettings();registerDocumentRoutes(app);registerLibraryRoutes(app);registerThreadRoutes(app);registerRunRoutes(app);registerSettingsRoutes(app);registerKnowledgeRoutes(app);registerExportRoutes(app);registerEditRoutes(app);
